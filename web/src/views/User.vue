...
import{Group} from "../ts/interface";
import {
  GetGroupListAPI,
  GetMemberByOrgAPI,
  GetRoleByOrgAPI,
...
const changeCurrentGrantRole = (val:Role) => {
  // 改变当前选定的角色
...
const changeCurrentRevokeRole = (val:Role) => {
...
const inviteMemberSearchUserList: Ref<User> = ref({ username: '', name: '', sex: '', roles: '' });
